...
\node (fig1) at (-2.5,0) {\includegraphics[height=5.0cm]{images/ebmMethod2Biomk}}; 
...
\includegraphics[height=3cm]{images/diagramPlots/abnormal1.png}};
\node (mixModelLabel) at (mixModel.north) {Region 1};
\node (mixModel2) at (4.6,2.5) {
\includegraphics[height=3cm,trim=50 0 0 0, clip]{images/diagramPlots/abnormal1.png}};
...
\begin{tikzpicture}[scale = 0.8]
  ...
  \node (pic) at (5,0) {\includegraphics[scale=0.4]{images/posVarianceMatrix.pdf}};
